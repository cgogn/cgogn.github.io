...
![Incidence graph](/assets/img/incidence_graph.svg)
_Figure 1: A cellular decomposition of a 2-dimensional object and its incidence graph_
...
![Cell-tuples](/assets/img/cell_tuples.svg)
_Figure 2: Iterative construction of the cell-tuples corresponding to the cellular decomposition of Figure 1_
...
![Generalized map](/assets/img/gmap.svg)
_Figure 3: The top figure shows the G-map corresponding to the cellular decomposition of Figure 1. Darts are represented like the cell-tuples in Figure 2; α0, α1 and α2 functions are represented respectively by blue, green and red links. The three bottom figures illustrate the sets of darts representing the vertex, edge and face of dart d._
...
<img align="center" src="/assets/img/oriented_gmap.svg" alt="Oriented map">
_Left: the darts of the G-map have been partitionned in two sets, each corresponding to one of the two orientations of the object. Right: the oriented combinatorial map yielded by dart d; φ1 = α1 ◦ α0 and φ2 = α2 ◦ α0 relations are represented respectively by blue-green and blue-red links._
